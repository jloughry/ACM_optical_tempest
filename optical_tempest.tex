...
% Format: LaTeX
%
% For information about this file, contact the authors by email at
% joe.loughry@applied-math.org, or by telephone: +1 720 277 7800. The
% timezone is GMT minus 7 hours.
%
% Last modified 05 March 2002 (removed references to Lockheed or lmco.com--rjl)
%
...
\firstfoot{ACM Transactions on Information and System Security, Vol.~5, No.~3,
August 2002, Pages 262--289.}

\runningfoot{ACM Transactions on Information and System Security, Vol.~5,
No.~3, August 2002.}
...
% \date{18 December 2000 \\ Revised 16 February 2002}
...
described that will successfully block this kind of ``Optical \textsc{Tempest}''
attack.

%
% 12 February 2002: The proprietary information label does not apply any
% longer, as a U.S. patent application was filed today.
%
% \begin{center}
...
\terms{Compromising emanations, Emissions security, Experimentation}

\keywords{Information displays, light emitting diode, LED, fiber optics,
encryption, compromising emanations, covert channel, communication, COMINT,
COMSEC, EMSEC, SIGINT, TEMPEST}
...
% See Appendix~\ref{appendix:power} for a more quantitative
% analysis of the optical energy available to an eavesdropper
% at a given distance.
...
\begin{figure}
\centering
\includegraphics[height=2in]{Figure_9.eps}
...
\received{Received April 2001; revised February 2002 and March 2002;
accepted March 2002}
